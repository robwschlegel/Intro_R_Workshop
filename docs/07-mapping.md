...
![(\#fig:map-goal)The goal for today.](figures/map_complete.pdf) 
...
![(\#fig:map-point-1)Dot plot of chicken weight data.](07-mapping_files/figure-latex/map-point-1-1.pdf) 
...
![(\#fig:map-point-2)Dot plot off South African coast.](07-mapping_files/figure-latex/map-point-2-1.pdf) 
...
![(\#fig:map-polygon)The map of South Africa. Now with province borders!](07-mapping_files/figure-latex/map-polygon-1.pdf) 
...
![(\#fig:map-province)The map of South Africa. Now with province borders!](07-mapping_files/figure-latex/map-province-1.pdf) 
...
![(\#fig:map-expand)The map, but with the extra bits snipped off.](07-mapping_files/figure-latex/map-expand-1.pdf) 
...
![(\#fig:map-MUR)Ocean temperature (°C) visualised as an ice cream spill.](07-mapping_files/figure-latex/map-MUR-1.pdf) 
...
![(\#fig:map-colour)Ocean temperatures (°C) around South Africa.](07-mapping_files/figure-latex/map-colour-1.pdf) 
...
![(\#fig:map-raster)Map of SOuth Africa showing *in situ* temeperatures (°C) as pixels along the coast.](07-mapping_files/figure-latex/map-raster-1.pdf) 
...
![(\#fig:map-final)The cleaned up map of South Africa. Resplendent with coastal and ocean temperatures (°C).](07-mapping_files/figure-latex/map-final-1.pdf) 
