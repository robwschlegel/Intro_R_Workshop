...
\begin{figure}
\includegraphics[width=19.61in]{figures/tidyverse} \caption{The Tidyverse by Hadley Wickham and co.}(\#fig:tidyverse)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figures/data-science-wrangle} \caption{Data tidying in the data processing pipeline. Reproduced from [R for Data Science](http://r4ds.had.co.nz/workflow-basics.html)}(\#fig:tidy)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figures/tidy-1} \caption{Following three rules make a dataset tidy --- variables are in columns, observations are in rows, and values are in cells. Reproduced from [R for Data Science](http://r4ds.had.co.nz/workflow-basics.html)}(\#fig:tidy-structure)
\end{figure}
...
![](10-tidy_files/figure-latex/tidy-1-1.pdf)<!-- --> 
