...
\begin{figure}
\includegraphics[width=19.44in]{figures/all_plt0_no_interp_natural} \caption{The effect of variance (SD) within a temperature time series on the accurate modelling of decadal trends.}(\#fig:example1)
\end{figure}

\begin{figure}
\includegraphics[width=17.82in]{figures/deeper-infamous-event-plots-1} \caption{The (currently) three most infamous marine heatwaves (MHWs) around the world.}(\#fig:example2)
\end{figure}

\begin{figure}
\includegraphics[width=29.17in]{figures/Ecography_figure5a-d} \caption{Changes in seaweed biodiversity along the South African coastline.}(\#fig:example4)
\end{figure}

\begin{figure}
\includegraphics[width=34.72in]{figures/insitu_polarPlots_month_v3.2} \caption{Polar plots of monthly temperatures.}(\#fig:example16)
\end{figure}

\begin{figure}
\includegraphics[width=20.25in]{figures/mo_coef} \caption{Most appropriate autoregressive correlation coefficients for areas around western boundary current.}(\#fig:example9)
\end{figure}

\begin{figure}
\includegraphics[width=18.93in]{figures/MUR_bathy_plot_discrete_20090228} \caption{The bathymetry of South Africa with SSTs from the MUR product.}(\#fig:example10)
\end{figure}

\begin{figure}
\includegraphics[width=22.22in]{figures/sw-fig-7-1} \caption{The power of the detected decadal trend at each coastal temperature collection site given a hypothetical number of months.}(\#fig:example13)
\end{figure}

\begin{figure}
\includegraphics[width=15.62in]{figures/false_bay_inset_map_labels2} \caption{An inset map of False Bay.}(\#fig:example5)
\end{figure}

\begin{figure}
\includegraphics[width=29.17in]{figures/PLOS_ONE_Fig4} \caption{The strength of the relationship between each site based on their biodiversity.}(\#fig:example19)
\end{figure}

\begin{figure}
\includegraphics[width=24.33in]{figures/hierarchical_clustsig} \caption{A hierarchical cluster analysis.}(\#fig:example15)
\end{figure}
...
![](04-graphics_files/figure-latex/basic-1-1.pdf)<!-- --> 
...
![](04-graphics_files/figure-latex/basic-3-1.pdf)<!-- --> 
...
![](04-graphics_files/figure-latex/first-lm-1.pdf)<!-- --> 
...
![](04-graphics_files/figure-latex/basic-6-1.pdf)<!-- --> 
...
![](04-graphics_files/figure-latex/basic-8-1.pdf)<!-- --> 
...
![](04-graphics_files/figure-latex/basic-4-1.pdf)<!-- --> 
