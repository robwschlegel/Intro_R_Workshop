...
```{r ggmap-2, fig.cap="Google map of Cape Point with site labels"}
cp_2 <- cp_1 +
...
```{r ggmap-labels, fig.cap="Google map of Cape Point with site labels AND specific labels."}
cp_3 <- cp_2 +
...
```{r ggmap-scale, fig.cap="Google map of Cape Point with labels and a scale bar."}
...
```{r ggmap-mini, fig.cap="A quick map of Africa to be insetted in our Cape Point map."}
# Load Africa shape
...
```{r ggmap-inset, fig.cap="Google map of Cape Point, with labels, scale bar, and an inset map of Africa."}
cp_5 <- cp_4 +
...
```{r ggmap-final, fig.cap="The final map with all of the bells and whistels."}
# Load library
library(scales)
