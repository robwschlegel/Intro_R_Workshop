...
```{r facet-dens, fig.cap="Density plot showing the distribution of final chicken weights (g) by diet."}
# Note that we are using 'ChickLast', not 'ChickWeight'
...
```{r facet-violin, fig.cap="Violin plot showing the distribution of final chicken weights (g) by diet."}
# Note that we are using 'ChickLast', not 'ChickWeight'
